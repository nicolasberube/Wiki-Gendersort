...
Ce code doit être utilisé seulement après l'utilisation de Assignation-update_part1.py. Voyez les commentaires de ce code pour plus d'information.
Si le code Assignation-update_part1.py a été interrompue, il faut utiliser le code présent Assignation-update_part2.py avant de relancer Assignation-update_part1.py
